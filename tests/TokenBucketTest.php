...
class TokenBucketTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->bucket = new TokenBucket($this->store, 100, 10.0);
    }
    ...
    {
        $this->bucket->allow('user:4', 50);
        $remaining = $this->bucket->getRemaining('user:4');
        $this->assertEqualsWithDelta(50.0, $remaining, 1.0);
    }

    public function testGetRemainingForNewKey(): void
    {
        $remaining = $this->bucket->getRemaining('user:new');
